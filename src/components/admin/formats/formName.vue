    ...
    >
        <a-row class="form-autoevaluation">
            ...
            <a-row :gutter="16">
                ...
                <a-col :md="6" :sm="24">
                    <a-form-item fieldDecoratorId="isAutoEvaluation">
                        <a-checkbox v-model="evaluation.isAutoEvaluation">
                            Auto Evaluación
                        </a-checkbox>
                    </a-form-item>
                </a-col>
                <a-col :md="6" :sm="24">
                    <a-form-item fieldDecoratorId="loadPreviousObjetives">
                        <a-checkbox v-model="evaluation.includePastObjectives">
