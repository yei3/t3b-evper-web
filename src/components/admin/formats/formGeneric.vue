        ...
        <a-row class="form-autoevaluation">
            <a-row class="form-tittle">
                <a-col :span="24" style="margin-bottom: 20px">
                    ...
                    >
                        {{ sectionTitle }}
                        <small style="font-size: 15px;"> {{ sectionPercent$ }}% </small>
                    </span>
                    ...
                    ><a-col :span="24">
                        ...
                        <a-tooltip placement="top" title="Visibilidad del título">
                            ...
                            <a-switch
                                ...
                                @change="
                                    subsection.title.visible = !subsection.title.visible;
                    ...
                    ><a-col
                        ...
                        >
                            ...
                            <a-form-item
                                ...
                                :fieldDecoratorId="
                                    'expectedValue-' + subsection.id + '-' + question.id
                                "
                                style="margin: 10px 0px;"
                            ...
                            >
                                ...
                                >
                                    <a-select-option
                                        v-for="(item, index) in objectiveRelationships"
                                        :key="index"
                                        :value="item.value"
                                    >
                                        {{ item.label }}
                            ...
                            <a-col :sm="24" :md="24" style="text-align: center; margin-top: 10px;">
                                <a-switch
                                    :checked="question.qualifiable"
                                    @change="
                                        question.qualifiable = !question.qualifiable;
                                ...
                                Calificable
                                <a
                                    @click="removeQuestion(subsection.key, question)"
                                ...
                                <a
                                    @click="saveQuestion(subsection.key, question)"
                                    class="link-delete-question form-icon"
            ...
            <a-row>
                <a-col :sm="24" :md="6" :offset="0">
                    <a-button
                        ...
                        type="dashed"
                        @click="
                            addSubsectionModal.visible = true;
                ...
                <a-modal title="Título de la Sección" v-model="sectionModal.visible">
                    <a-input
                ...
                <a-modal title="Agregar nueva subsección" v-model="addSubsectionModal.visible">
                    <a-input
                        addonBefore="Título"
                    ...
                    <template slot="footer">
                        <a-row>
                            <a-col :span="12" style="text-align: left;">
                                <a-button
                                    @click="
                                        addSubsectionModal.visible = false;
                                        addSubsectionModal.value = '';
                                    "
                                >
                                    Cancelar
        ...
        async saveQuestion(sectionId, _question) {
            ...
            if (question.answerType === 3) {
                ...
                if (Number.isNaN(Number(question.expectedValue)) && data.relation === 3) {
                    ...
                    const msg =
                        "Los Objetivos tipo texto solo son permitidos con la relación de igualdad"; // eslint-disable-line
            ...
            response = await client3B.question
                .create(data, {
