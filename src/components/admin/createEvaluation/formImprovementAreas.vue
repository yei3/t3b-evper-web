    ...
    >
        <a-row class="form-autoevaluation">
            ...
            <a-row >
                <a-col :sm="24" :md="24">
                    <a-form-item
                        label="Descripción de la sección de Áreas de Mejora"
                        ...
                        :fieldDecoratorOptions="{
                            rules: [
                                {
                                    required: true,
                                    message: 'Ingresa la descripción la sección de Áreas de Mejora'
                                }
                            ]
                        }"
                    >
    ...
    methods: {
        ...
        saveStrengths(formValues) {
            this.updateEvaluationForm({
                improvementAreasDescription: formValues.description,
            });
            this.nextStep();
        },
        handleForm(e) {
