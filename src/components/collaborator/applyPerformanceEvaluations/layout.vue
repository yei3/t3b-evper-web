                    ...
                    <div class="collapse-content" v-show="!collapsed">
                        <a-row :gutter="16">
                            ...
                            >
                                ...
                                <div
                                    class="step-form step-form-current"
                                ...
                                <div
                                    class="step-form step-form-not-done"
...
export default {
    ...
    beforeCreate() {
        this.$store.commit("evaluationClearQuestions");
    },
    async created() {
    ...
    methods: {
        async fetchEvaluation() {
            ...
            if (this.evaluation == null) {
                ...
                this.evaluatedName = `${this.evaluation.user.name}  ${
                    this.evaluation.user.surname
                }`;
            }
            ...
            if (sectNextObj) {
                this.evaluation.template.sections.splice(
                    this.evaluation.template.sections.length,
                    0,
                    sectNextObj,
                );
            }
